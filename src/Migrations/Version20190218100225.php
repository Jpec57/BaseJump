 ...
 */
final class Version20190218100225 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE promote_demote_request (id INT AUTO_INCREMENT NOT NULL, username VARCHAR(255) NOT NULL, is_promoting TINYINT(1) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
