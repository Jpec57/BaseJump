 ...
 */
final class Version20190218143134 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE event CHANGE is_answer_visible is_answer_visible TINYINT(1) NOT NULL');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE event CHANGE is_answer_visible is_answer_visible VARCHAR(255) NOT NULL COLLATE utf8mb4_unicode_ci');
    }
}
